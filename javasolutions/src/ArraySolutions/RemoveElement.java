 ...
 * 
 * int[] nums = [...]; // Input array int val = ...; // Value to remove int[] expectedNums = [...];
 * // The expected answer with correct length. // It is sorted with no values equaling val.
 * 
 * int k = removeElement(nums, val); // Calls your implementation
 * 
 * assert k == expectedNums.length; sort(nums, 0, k); // Sort the first k elements of nums for (int
 * i = 0; i < actualLength; i++) { assert nums[i] == expectedNums[i]; }
 * 
 ...
 * Example 1:
 * 
 * Input: nums = [3,2,2,3], val = 3 Output: 2, nums = [2,2,_,_] Explanation: Your function should
 ...
 * Example 2:
 * 
 * Input: nums = [0,1,2,2,3,0,4,2], val = 2 Output: 5, nums = [0,1,4,0,3,_,_,_] Explanation: Your
